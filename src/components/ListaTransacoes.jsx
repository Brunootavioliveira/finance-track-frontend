...
function TransacaoItem({ transacao, onDelete }) {
  ...
  return (
    <div
      className="group flex items-center justify-between py-3 px-3 sm:px-5 rounded-xl transition-all duration-200"
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold text-white truncate">{transacao.description}</p>
          <p className="text-xs mt-0.5 truncate" style={{ color: '#4A5177' }}>
    ...
    <div className="rounded-2xl p-4 sm:p-6" style={{
      ...
      <div className="flex items-center justify-between mb-2 px-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold text-white">Últimas Transações</h2>
